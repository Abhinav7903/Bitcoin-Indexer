...
data_directory = '/mnt/ssd/postgres16/main'		# use data in another directory
...
max_parallel_maintenance_workers = 4	# limited by max_parallel_workers
max_parallel_workers = 16		# number of max_worker_processes that
...
log_directory = '/mnt/ssd/pglogs'       #directory where log files are written,
...
#temp_tablespaces = '/mnt/ssd/pgtmp'			# a list of tablespace names, '' uses
